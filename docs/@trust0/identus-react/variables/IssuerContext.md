...
> `const` **IssuerContext**: `Context`\<[`AgentContextType`](../type-aliases/AgentContextType.md) & `object` \| `undefined`\>

Defined in: [packages/identus-react/src/context/index.ts:377](https://github.com/trust0-project/identus/blob/a9055153b7b08ad39900d9f5ee0efffa8bc04846/packages/identus-react/src/context/index.ts#L377)
