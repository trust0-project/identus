...
export const secp256K1 = new SDK.Secp256k1KeyPair(
  secpPrivateKey,
  secpPrivateKey.publicKey()
);

const ed25519PrivateKey = new SDK.Ed25519PrivateKey(
  base64url.baseDecode("JLIJQ5jlkyqtGmtOth6yggJLLC0zuRhUPiBhd1-rGPs")
);
export const ed25519 = new SDK.Ed25519KeyPair(
  ed25519PrivateKey,
  ed25519PrivateKey.publicKey()
);

const x25519PrivateKey = new SDK.X25519PrivateKey(
  base64url.baseDecode("eHbEtI71XIBIsuQK7XdjZ_ZPnLZb3y4paWoqSoS7BnI")
);
export const x25519 = new SDK.X25519KeyPair(
  x25519PrivateKey,
